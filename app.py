...
st.markdown("Atout CHOMBA rompe le scattole")
st.markdown("This text is :red[colored red], and this is **:blue[colored]** and bold.")
st.markdown(":green[$\sqrt{x^3+y^2}=1$] is a Pythagorean identity. :pencil:")
st.markdown("Cosa ci porta sto cazzo di ML ?????")

# # ###################################################
# #title
st.title('This is a title')
st.title('A title with _italics_ :blue[colors] and emojis :sunglasses:')
st.title("QUI CHE METERO IL MIO CV")
# # # ###################################################
# #header
st.header('This is a header')
st.header("Mi chiamo Atout CHOMBA")
st.header('A header with _italics_ :blue[colors] and emojis :sunglasses:')

# # # ###################################################
# #subheader
st.subheader('This is a subheader')
st.subheader("+393338250551")
